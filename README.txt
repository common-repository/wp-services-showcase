...
Donate link:
Tags: services, products, portfolio, showcase, service, product, list, staff, employees, shortCode, icons, grid, template, custom post type, wp services
Requires at least: 3.5
Tested up to: 4.9
Stable tag: 1.0
License: GPLv2 or later

Fully Responsive and Mobile Friendly way to showcase your services or products on your website.

== Description ==

[Plugin Demo](http://demo.radiustheme.com/wordpress/plugins/wp-services-showcase/) [Documentation](https://radiustheme.com/setup-configure-wp-services-showcase/)
